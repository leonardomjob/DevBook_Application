...
// NovoRepositorioDeUsuarios cria um repositorios de usuarios
...
// BuscarPorID traz um usuario especifico do banco de dados
func (repositorio Usuarios) BuscarPorID(ID uint64) (modelos.Usuario, error) {
	...
	if erro != nil {
		return modelos.Usuario{}, erro // Usuario com todos os valores 0
	}
	defer linhas.Close()
...
// Atualizar altera os dados de um usuario no banco de dados
...
// Deletar exclui as informaçoes de um usuarios no banco de dados
...
// BuscarSeguindo traz todos os seguindo do usuario
